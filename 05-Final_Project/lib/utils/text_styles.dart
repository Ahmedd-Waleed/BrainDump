...
/// Colors are theme-aware via the .adapt() helper.
...
/// Theme-aware text style extension.
/// Usage: AppTextStyles.title.adapt(context)
extension AdaptiveTextStyle on TextStyle {
  TextStyle adapt(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;

    if (color == AppColors.neutralBlack) {
      return copyWith(
        color: isDark ? AppColors.darkText : AppColors.neutralBlack,
      );
    }
    if (color == AppColors.neutralDark) {
      return copyWith(
        color: isDark ? AppColors.darkTextSecondary : AppColors.neutralDark,
      );
    }
    if (color == AppColors.neutralGray) {
      return copyWith(
        color: isDark ? AppColors.darkTextSecondary : AppColors.neutralGray,
      );
    }
    return this;
  }
